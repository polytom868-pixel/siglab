...
class SoSoValueClient:
    ...
    def cache_info(self) -> dict[str, Any]:
        """Return cache stats."""
        return {'enabled': self._cache_enabled, 'size': len(self._response_cache), 'max_size': self._max_cache_size, 'hits': self._cache_hits, 'misses': self._cache_misses}
