...
def perps_new_order_body(*, account_id: int, symbol_id: int, orders: list[OrderedDict[str, Any]]) -> OrderedDict[str, Any]:
    ...
    return _perps_action_body('newOrder', [('accountID', validate_account_id(account_id)), ('symbolID', int(symbol_id)), ('orders', orders)])

def perps_update_leverage_body(*, account_id: int, symbol_id: int, leverage: int, margin_mode: int) -> OrderedDict[str, Any]:
    return _perps_action_body('updateLeverage', [('accountID', validate_account_id(account_id)), ('symbolID', int(symbol_id)), ('leverage', int(leverage)), ('marginMode', int(margin_mode))])
...
def perps_cancel_order_body(*, account_id: int, cancels: list[OrderedDict[str, Any]]) -> OrderedDict[str, Any]:
    ...
    return _perps_action_body('cancelOrder', [('accountID', validate_account_id(account_id)), ('cancels', cancels)])

def perps_schedule_cancel_body(*, account_id: int, scheduled_timestamp: int | None=None) -> OrderedDict[str, Any]:
    return _perps_action_body('scheduleCancel', [('accountID', validate_account_id(account_id)), ('scheduledTimestamp', int(scheduled_timestamp) if scheduled_timestamp is not None else None)])
...
def perps_update_margin_body(*, account_id: int, symbol_id: int, amount: str) -> OrderedDict[str, Any]:
    ...
    return _perps_action_body('updateMargin', [('accountID', validate_account_id(account_id)), ('symbolID', int(symbol_id)), ('amount', amount)])
