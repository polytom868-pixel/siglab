...
class SigLabStatusBar(Widget):
    ...
    def __init__(self, version: str='0.1.0', api_url: str='http://localhost:8080', **kwargs: Any) -> None:
    ...
    def _update_display(self) -> None:
        ...
        left = Text.assemble((f' SigLab v{self._version} ', 'bold'), (f'[{conn_icon}] ', conn_color), (f'{self._api_url}', TEXT_MUTED))
