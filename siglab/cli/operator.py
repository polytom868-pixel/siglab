...
def add_subparser(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    parser = subparsers.add_parser(
        "operator",
        help="Run the OperatorPipeline — evidence-to-decision cycle.",
    )
    parser.add_argument(
        "--spec",
        default=None,
    ...
    parser.add_argument(
        "--sessions-dir",
        default=None,
        help="Directory for paper session files.",
    )
...
async def run_operator(args: argparse.Namespace) -> None:
    ...
    # Determine dry-run from the --live flag
    ...
    # Build spec from --spec path or empty
    spec: dict[str, Any] = {}
    if args.spec:
    ...
    # Build market_data stub (future: accept live data feeds)
    ...
    # Place paper order if a session was provided
