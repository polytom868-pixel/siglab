...
class SiglabConfig:
    ...
    sosovalue_etf_base_url: str = "https://api.sosovalue.xyz"
...
def load_settings() -> SiglabConfig:
    ...
    return SiglabConfig(
        ...
        sosovalue_openapi_base_url=str(_get("SOSOVALUE_OPENAPI_BASE_URL", "https://openapi.sosovalue.com/openapi/v1")),
        sosovalue_etf_base_url=str(_get("SOSOVALUE_ETF_BASE_URL", "https://api.sosovalue.xyz")),
        sosovalue_news_base_url=str(_get("SOSOVALUE_NEWS_BASE_URL", "https://openapi.sosovalue.com")),
        ...
        bai_base_url=str(_get("ANTHROPIC_BASE_URL", "https://api.b.ai")),
        bai_model=str(_get("ANTHROPIC_MODEL", "deepseek-v4-flash")),
        bai_planner_model=str(_get("BAI_PLANNER_MODEL", _get("ANTHROPIC_MODEL", "deepseek-v4-flash"))),
        bai_writer_model=str(_get("BAI_WRITER_MODEL", "deepseek-v4-flash")),
        bai_reflector_model=str(_get("BAI_REFLECTOR_MODEL", "deepseek-v4-flash")),
        bai_fallback_fast_model=str(_get("BAI_FALLBACK_FAST_MODEL", "kimi-k2.5")),
