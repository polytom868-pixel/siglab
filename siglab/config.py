...
def load_settings() -> SiglabConfig:
    ...
    return SiglabConfig(
        ...
        sosovalue_etf_base_url=_get("SOSOVALUE_ETF_BASE_URL", "https://api.sosovalue.xyz"),
        ...
        bai_fallback_reasoning_model=_get("BAI_FALLBACK_REASONING_MODEL", "deepseek-v4-pro"),
