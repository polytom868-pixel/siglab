...
class ClaudeClient:
    ...
    async def complete_text_with_tools(
        ...
        *,
        ...
        remaining_rounds = max_tool_rounds or self.settings.claude_max_tool_rounds
        trace: dict[str, Any] = {
            "provider": self.provider_name,
            "model": selected_model,
            "thinking_mode": thinking_type or "default",
        ...
        while True:
            ...
            if tool_calls and tool_map:
                if remaining_rounds <= 0:
                    ...
                    raise RuntimeError("Claude tool loop exceeded configured max rounds")
                remaining_rounds -= 1
    ...
    def _extract_message_content(self, body: dict[str, Any]) -> str:
        ...
        if isinstance(content, list):
            ...
            if pieces:
                return "\n".join(pieces)
        raise ValueError("Claude response content was not a string")
